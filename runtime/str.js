...
const upper__ink_qm__ = checkRange(point(__Ink_String(`A`)) - 1, __as_ink_string(point(__Ink_String(`Z`)) + 1));
module.exports.upper__ink_qm__ = upper__ink_qm__;
const lower__ink_qm__ = checkRange(point(__Ink_String(`a`)) - 1, __as_ink_string(point(__Ink_String(`z`)) + 1));
module.exports.lower__ink_qm__ = lower__ink_qm__;
const digit__ink_qm__ = checkRange(point(__Ink_String(`0`)) - 1, __as_ink_string(point(__Ink_String(`9`)) + 1));
...
const matchesAt__ink_qm__ = (s, substring, idx) => (() => {let max = len(substring); return (() => {sub = i => {return __ink_match(i, [[() => max, () => true], [() => __Ink_Empty, () => __ink_match((() => {let __ink_acc_trgt = __as_ink_string(s); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return __as_ink_string(idx + i)})()] || null : (__ink_acc_trgt[(() => {return __as_ink_string(idx + i)})()] !== undefined ? __ink_acc_trgt[(() => {return __as_ink_string(idx + i)})()] : null)})(), [[() => (() => {return (() => {let __ink_acc_trgt = __as_ink_string(substring); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return i})()] || null : (__ink_acc_trgt[(() => {return i})()] !== undefined ? __ink_acc_trgt[(() => {return i})()] : null)})()})(), () => sub(__as_ink_string(i + 1))], [() => __Ink_Empty, () => false]])]])}; return sub})()(0)})();
module.exports.matchesAt__ink_qm__ = matchesAt__ink_qm__;
const index = (s, substring) => (() => {let max = len(s) - 1; return (() => {sub = i => {return __ink_match(matchesAt__ink_qm__(s, substring, i), [[() => true, () => i], [() => false, () => __ink_match(i < max, [[() => true, () => sub(__as_ink_string(i + 1))], [() => false, () => __ink_negate(1)]])]])}; return sub})()(0)})();
...
const trimPrefixNonEmpty = (s, prefix) => (() => {let max = len(s); let lpref = len(prefix); let idx = (() => {sub = i => {return __ink_match(i < max, [[() => true, () => __ink_match(matchesAt__ink_qm__(s, prefix, i), [[() => true, () => sub(__as_ink_string(i + lpref))], [() => false, () => i]])], [() => false, () => i]])}; return sub})()(0); return slice(s, idx, len(s))})();

...
const map = (() => {let __ink_acc_trgt = __as_ink_string(std); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[map] : (__ink_acc_trgt.map !== undefined ? __ink_acc_trgt.map : null); })();
module.exports.map = map;
const slice = (() => {let __ink_acc_trgt = __as_ink_string(std); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[slice] : (__ink_acc_trgt.slice !== undefined ? __ink_acc_trgt.slice : null); })();
module.exports.slice = slice;
const reduce = (() => {let __ink_acc_trgt = __as_ink_string(std); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[reduce] : (__ink_acc_trgt.reduce !== undefined ? __ink_acc_trgt.reduce : null); })();
module.exports.reduce = reduce;
const reduceBack = (() => {let __ink_acc_trgt = __as_ink_string(std); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[reduceBack] : (__ink_acc_trgt.reduceBack !== undefined ? __ink_acc_trgt.reduceBack : null); })();
...
const hasPrefix__ink_qm__ = (s, prefix) => {return reduce(prefix, (acc, c, i) => {return __ink_and(acc, (() => {return __ink_eq((() => {let __ink_acc_trgt = __as_ink_string(s); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return i})()] : (__ink_acc_trgt[(() => {return i})()] !== undefined ? __ink_acc_trgt[(() => {return i})()] : null); })(), c)})())}, true)};
module.exports.hasPrefix__ink_qm__ = hasPrefix__ink_qm__;
const hasSuffix__ink_qm__ = (s, suffix) => (() => {let diff = len(s) - len(suffix); return reduce(suffix, (acc, c, i) => {return __ink_and(acc, (() => {return __ink_eq((() => {let __ink_acc_trgt = __as_ink_string(s); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return i + diff})()] : (__ink_acc_trgt[(() => {return i + diff})()] !== undefined ? __ink_acc_trgt[(() => {return i + diff})()] : null); })(), c)})())}, true)})();
module.exports.hasSuffix__ink_qm__ = hasSuffix__ink_qm__;
const matchesAt__ink_qm__ = (s, substring, idx) => (() => {let max = len(substring); return (() => {sub = (i) => {return __ink_match(i, [[() => max, () => true], [() => __Ink_Empty, () => __ink_match((() => {let __ink_acc_trgt = __as_ink_string(s); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return idx + i})()] : (__ink_acc_trgt[(() => {return idx + i})()] !== undefined ? __ink_acc_trgt[(() => {return idx + i})()] : null); })(), [[() => (() => {return (() => {let __ink_acc_trgt = __as_ink_string(substring); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return i})()] : (__ink_acc_trgt[(() => {return i})()] !== undefined ? __ink_acc_trgt[(() => {return i})()] : null); })()})(), () => sub(i + 1)], [() => __Ink_Empty, () => false]])]])}; return sub})()(0)})();

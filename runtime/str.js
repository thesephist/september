...
matchesAt__ink_qm__ = (s, substring, idx) => (() => {let max = len(substring); return (() => {let sub = i => (() => {let __ink_trampolined_sub = i => {return __ink_match(i, [[() => max, () => true], [() => __Ink_Empty, () => __ink_match((() => {let __ink_acc_trgt = __as_ink_string(s); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return __as_ink_string(idx + i)})()] || null : (__ink_acc_trgt[(() => {return __as_ink_string(idx + i)})()] !== undefined ? __ink_acc_trgt[(() => {return __as_ink_string(idx + i)})()] : null)})(), [[() => (() => {return (() => {let __ink_acc_trgt = __as_ink_string(substring); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[(() => {return i})()] || null : (__ink_acc_trgt[(() => {return i})()] !== undefined ? __ink_acc_trgt[(() => {return i})()] : null)})()})(), () => __ink_trampoline(__ink_trampolined_sub, __as_ink_string(i + 1))], [() => __Ink_Empty, () => false]])]])}; return __ink_resolve_trampoline(__ink_trampolined_sub, i)})(); return sub})()(0)})();
module.exports.matchesAt__ink_qm__ = matchesAt__ink_qm__;
index = (s, substring) => (() => {let max = (len(s) - 1); return (() => {let sub = i => (() => {let __ink_trampolined_sub = i => {return __ink_match(matchesAt__ink_qm__(s, substring, i), [[() => true, () => i], [() => false, () => __ink_match((i < max), [[() => true, () => __ink_trampoline(__ink_trampolined_sub, __as_ink_string(i + 1))], [() => false, () => __ink_negate(1)]])]])}; return __ink_resolve_trampoline(__ink_trampolined_sub, i)})(); return sub})()(0)})();
...
trimPrefixNonEmpty = (s, prefix) => (() => {let max = len(s); let lpref = len(prefix); let idx = (() => {let sub = i => (() => {let __ink_trampolined_sub = i => {return __ink_match((i < max), [[() => true, () => __ink_match(matchesAt__ink_qm__(s, prefix, i), [[() => true, () => __ink_trampoline(__ink_trampolined_sub, __as_ink_string(i + lpref))], [() => false, () => i]])], [() => false, () => i]])}; return __ink_resolve_trampoline(__ink_trampolined_sub, i)})(); return sub})()(0); return slice(s, idx, len(s))})();
...
trimSuffixNonEmpty = (s, suffix) => (() => {let lsuf = len(suffix); let idx = (() => {let sub = i => (() => {let __ink_trampolined_sub = i => {return __ink_match((i > __ink_negate(1)), [[() => true, () => __ink_match(matchesAt__ink_qm__(s, suffix, (i - lsuf)), [[() => true, () => __ink_trampoline(__ink_trampolined_sub, (i - lsuf))], [() => false, () => i]])], [() => false, () => i]])}; return __ink_resolve_trampoline(__ink_trampolined_sub, i)})(); return sub})()(len(s)); return slice(s, 0, idx)})();

...
const slice = (std.slice !== undefined ? std.slice : null);
module.exports.slice = slice;
const reduce = (std.reduce !== undefined ? std.reduce : null);
module.exports.reduce = reduce;
const reduceBack = (std.reduceBack !== undefined ? std.reduceBack : null);
...
const hasPrefix__ink_qm__ = (s, prefix) => {return reduce(prefix, (acc, c, i) => {return __ink_and(acc, (() => {return __ink_eq((s[(() => {return i})()] !== undefined ? s[(() => {return i})()] : null), c)})())}, true)};
module.exports.hasPrefix__ink_qm__ = hasPrefix__ink_qm__;
const hasSuffix__ink_qm__ = (s, suffix) => (() => {let diff = len(s) - len(suffix); return reduce(suffix, (acc, c, i) => {return __ink_and(acc, (() => {return __ink_eq((s[(() => {return i + diff})()] !== undefined ? s[(() => {return i + diff})()] : null), c)})())}, true)})();
module.exports.hasSuffix__ink_qm__ = hasSuffix__ink_qm__;
const matchesAt__ink_qm__ = (s, substring, idx) => (() => {let max = len(substring); return (() => {sub = (i) => {return __ink_match(i, [[() => max, () => true], [() => __Ink_Empty, () => __ink_match((s[(() => {return idx + i})()] !== undefined ? s[(() => {return idx + i})()] : null), [[() => (() => {return (substring[(() => {return i})()] !== undefined ? substring[(() => {return i})()] : null)})(), () => sub(i + 1)], [() => __Ink_Empty, () => false]])]])}; return sub})()(0)})();
